...
public class Cell : MonoBehaviour
{
    ...
    public void IncreaseValue()
    {
        ...
        GameController.Instanse.AddPoints(Points);
    }
    ...
    {
        CellAnimationController.Instanse.SmoothTransmition(this, otherCell, true);
    ...
    {
        CellAnimationController.Instanse.SmoothTransmition(this, target, false);
    ...
    public void UpdateCell()
    {
        ...
        points.color = Value <= 2 ? ColorManager.Instamse.PointsDarkColor : ColorManager.Instamse.PointsLightColor;

        image.color = ColorManager.Instamse.CellColors[Value];
    }

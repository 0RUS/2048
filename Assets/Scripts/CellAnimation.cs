...
public class CellAnimation : MonoBehaviour
{
    ...
    public void Move(Cell from, Cell to, bool isMerging)
    {
        ...
        image.color = ColorManager.Instamse.CellColors[from.Value];
        points.text = from.Points.ToString();
        points.color = from.Value <= 2 ?
            ColorManager.Instamse.PointsDarkColor :
            ColorManager.Instamse.PointsLightColor;
        ...
        if (isMerging)
        {
            ...
            {
                image.color = ColorManager.Instamse.CellColors[to.Value];
    ...
    public void Appear(Cell cell)
    {
        ...
        image.color = ColorManager.Instamse.CellColors[cell.Value];
